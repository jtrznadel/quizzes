...
class _UserClient implements UserClient {
  ...
  @override
  Future<void> convertGuestToUser(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<List<QuizzArchiveModel>> getUserQuizzArchive() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<QuizzArchiveModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var _value = _result.data!
        .map((dynamic i) =>
            QuizzArchiveModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return _value;
  }
