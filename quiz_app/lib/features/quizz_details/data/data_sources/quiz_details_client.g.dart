...
class _QuizDetailsClient implements QuizDetailsClient {
  ...
  @override
  Future<void> updateQuizDetails(Map<String, dynamic> quizDetails) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(quizDetails);
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
  ...
  Future<void> addQuestion(Map<String, dynamic> question) async {
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'questionsandanswers/create-question',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> updateQuestion(Map<String, dynamic> question) async {
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'questionsandanswers/update-question',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
